    ...
    return (
        <View style={{ backgroundColor: COLORS.white }}>
            <View style={EstilosEditar.header}>
                ...
                <Text style={{ fontSize: 20, fontWeight: 'bold', marginLeft: 20 }}>Guardar Colaborador</Text>
            </View>
            <ScrollView style={{marginTop:0}}>
            <View>
                <View style={EstilosEditar.contenedorContenido}>
                    <Text style={EstilosEditar.etiqueta}>Nombre del Colaborador</Text>
                    <TextInput style={EstilosEditar.inputs}>Jesús</TextInput>
                </View>

                <View style={EstilosEditar.contenedorContenido}>
                    <Text style={EstilosEditar.etiqueta}>Apellido de Colaborador</Text>
...
export default GuardarColaborador;